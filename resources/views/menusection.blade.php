        ...
        <div class="menu-item-carousel">
            <div class="col-lg-12">
                ...
                -->
                    ...
                    <div class="item">
                        <div class="card" height="" style=" object-fit: contain; width: 100%; background-image: url('/foodimage/{{ $data->image }}');">
                    ...
                    <div class="item">
                        <div class='card card3'>
                            ...
                            <div class='info'>
                              ...
                              <p class='description'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sedii do eiusmod teme.</p>
                              <div class="main-text-button">
                                  <div class="scroll-to-section"><a href="#reservation">Make Reservation <i class="fa fa-angle-down"></i></a></div>s
                              </div>
                            </div>
                        </div>
                    </div> -->
